            ...
            <div className='mx-auto max-w-xl flex flex-col items-center gap-10'>
                ...
                <div className='text-sm text-center '>
                    <ul className='flex items-center justify-center mb-2'>
                        <li className='px-4 border-r border-r-[#626381] last:border-none'>Careers</li>
                        <li className='px-4 border-r border-r-[#626381] last:border-none'>Privacy Policy</li>
                        <li className='px-4 border-r border-r-[#626381] last:border-none'>Terms & Condition</li>
                    </ul>
